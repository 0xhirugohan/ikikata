 ...
 */
export async function generateAccountIdFromPublicKey(publicKey: CryptoKey): Promise<string> {
 ...
 */
export async function validatePublicKey(publicKeyB64: string): Promise<boolean> {
  try {
