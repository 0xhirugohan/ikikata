...
export default function AccountManager({ isDarkMode, onAccountChange }: AccountManagerProps) {
    ...
    return (
      <div className="p-6 space-y-6">
        ...
        <div className={`p-4 rounded-lg ${
          isDarkMode ? 'bg-slate-700 border border-slate-600' : 'bg-blue-50 border border-blue-200'
        }`}>
        ...
        {error && (
          <div className={`p-3 rounded-lg ${
            isDarkMode ? 'bg-red-900/30 text-red-400 border border-red-800' : 'bg-red-50 text-red-600 border border-red-200'
          }`}>
            {error}
          </div>
        )}
      ...
      <div className="p-6 space-y-6">
        ...
        <div className={`p-4 rounded-lg ${
          ...
          <p className={`text-sm ${
            ...
            This phrase is the ONLY way to recover your account. Store it securely and never share it with anyone.
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className={`p-3 rounded-lg border font-mono text-sm ${
            showRecoveryPhrase
              ? isDarkMode ? 'bg-slate-800 border-slate-600 text-slate-200' : 'bg-gray-50 border-gray-300 text-gray-800'
              : isDarkMode ? 'bg-slate-800 border-slate-600 text-slate-500' : 'bg-gray-50 border-gray-300 text-gray-500'
          }`}>
        ...
        <div className={`rounded-lg border p-4 ${
          ...
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
              <span className={isDarkMode ? 'text-slate-400' : 'text-gray-600'}>Created:</span>
